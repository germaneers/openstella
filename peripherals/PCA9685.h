...
public:
	static bool softwareReset(AbstractI2cController *i2c);
	PCA9685(AbstractI2cController *i2c, uint8_t addr, GPIOPin outputEnablePin);
	...
	bool getSubAddress1(uint8_t *value) { return get8BitRegister(0x02, value); }
	bool getSubAddress2(uint8_t *value) { return get8BitRegister(0x03, value); }
	bool getSubAddress3(uint8_t *value) { return get8BitRegister(0x04, value); }
	bool getAllCallAddress(uint8_t *value) { return get8BitRegister(0x05, value); }

	bool setSubAddress1(uint8_t addr) { return set8BitRegister(0x02, addr); }
	bool setSubAddress2(uint8_t addr) { return set8BitRegister(0x03, addr); }
	bool setSubAddress3(uint8_t addr) { return set8BitRegister(0x04, addr); }
	bool setAllCallAddress(uint8_t addr) { return set8BitRegister(0x05, addr); }

	bool setLedParameters(uint8_t channel, uint16_t onTime, uint16_t offTime);
